...
Check that your model meets Roblox's [avatar character specifications](../../avatar/character-bodies/specifications.md) before exporting to ensure Studio compatibility.
...
6. In the **Animation** section, enable **Animation**. Avatar characters with [animatable heads](../../avatar/dynamic-heads/index.md) require animation data.
