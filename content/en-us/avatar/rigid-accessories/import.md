...
Keep in mind, the model that you intend to create as a rigid accessory must also follow Roblox's [accessory specifications](./specifications.md) to eventually use this asset as an `Class.Accessory`, or you may experience errors later in the workflow.
