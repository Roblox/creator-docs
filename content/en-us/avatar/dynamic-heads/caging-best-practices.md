...
A character's dynamic head cage helps define the surface of the 3D model. The cage also plays an important role in Marketplace [head validation](./validate.md), so it's important to properly construct cages to ensure accurate fitting with head accessories and animations.
