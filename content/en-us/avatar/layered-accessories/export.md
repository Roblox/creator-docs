...
7. After exporting, use Studio's [Importer](../../studio/importer.md) to import your model and the [Accessory Fitting Tool](../../avatar/accessory-fitting-tool.md) to convert the model into an accessory.
...
9. After exporting, use Studio's [Importer](../../studio/importer.md) to import your model and the [Accessory Fitting Tool](../../avatar/accessory-fitting-tool.md) to convert the model into an accessory.
