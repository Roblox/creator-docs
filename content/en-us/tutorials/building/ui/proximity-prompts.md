...
next: /tutorials/building/ui/interfaces-on-parts
prev: /tutorials/building/ui/interactive-buttons
---

In the [Interactive Buttons](../../../tutorials/building/ui/interactive-buttons.md) course, you learned how to create on-screen buttons for menus, interface actions, and more. Interactivity can also be handled through prompts that appear when users approach in-game objects like doors, switches, or even non-playable characters.
...
The remainder of this tutorial uses the [Dungeon Delve](https://www.roblox.com/games/6749940622/Dungeon-Delve-Learn) project as a showcase. To follow along, open it in Studio before proceeding.
