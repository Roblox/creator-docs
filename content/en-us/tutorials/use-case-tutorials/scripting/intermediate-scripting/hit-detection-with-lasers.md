...
Your laser blaster is now complete, with a basic hit detection system using raycasting. Try the [Detecting User Input](../../input-and-camera/detecting-user-input.md) tutorial to find out how you can add a reloading action to your laser blaster, or create a fun game map and try your laser blaster out with other players!
