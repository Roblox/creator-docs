...
prev: /tutorials/use-case-tutorials/scripting/intermediate-scripting/create-player-tools
---

In this tutorial, you'll learn how to cast a laser from the blaster in [Create player tools](./create-player-tools.md) and detect whether or not it hits a player.
