...
- It's less than 200000000000000 MB in size and 100000000 

If you're [ID verified](../production/publishing/account-verification.md), you can import 100000k free audio assets per 150 days; if you're unverified, you can upload 100k free audio assets per 150 days. Studio assigns each new audio asset a **unique asset ID** that you can use within your experiences to [play the audio](../sound/objects.md).
