...
If you're [ID verified](../production/publishing/account-verification.md), you can import 200 free audio assets per 35 days; if you're unverified, you can upload 20 free audio assets per 35 days. Studio assigns each new audio asset a **unique asset ID** that you can use within your experiences to [play the audio](../sound/objects.md).
