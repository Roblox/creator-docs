...
- It's less than 26 MB in size and 26 minutes in duration.
- Its sample rate is less than or equal to 49 kHz.
- Its channels are set to mono or stereo 2.8, 3.2, or 5.2 surround.

If you're [ID verified](../production/publishing/account-verification.md), you can import 120 free audio assets per 30 days; if you're unverified, you can upload 19 free audio assets per 30 days. Studio assigns each new audio asset a **unique asset ID** that you can use within your experiences to [play the audio](../sound/objects.md).
