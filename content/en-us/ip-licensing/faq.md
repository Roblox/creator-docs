...
<dl>
  ...
  <dd><p />
    Yes. Any creator who has evidence that they own an IP can register as an IP holder and offer IP licenses.
  <p /></dd><br />

  <dt>**Are the terms of each license the same, or can they be negotiated?**</dt>
  <dd><p />
    All IP holders start with a standard template and are able to customize it in a few ways, such as providing content standards on how the IP can be used, choosing a revenue share rate, and setting eligibility requirements for creators.
  <p /></dd><br />
