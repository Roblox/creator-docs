...
description: Explains why and how to test your experience on real devices to catch performance and usability issues before your players do.
---
...
- **Android** represents roughly 65% of a typical experience's player base.
...
Testing strategies depend on your experience and your development workflow — there's no single approach that fits every project. The following provide a solid baseline for integrating hardware testing into your process.
...
- Open the Developer Console with <kbd>F9</kbd> (or the in-experience menu) to check memory consumption under the **Memory** tab.
...
Once your experience is live, use the [Performance Dashboard](./monitor.md) to track client frame rate, memory usage, and crash rates across device categories over time. A sudden uptick in crashes after an update often points to a memory regression on low-end devices.
