...
description: Learn how to get started using Roblox in the classroom. Find teacher training, get lessons, and discover games to play.
---
<img src="../../assets/landing/education/banner.jpg" alt="Get Started with Roblox Education" width="100%" />
**Discover resources, best practices, and lesson plans to incorporate Roblox games into your classroom.**
...
<Grid item container direction="column" XSmall={12} Medium={6} Large={8} style={{flex: 1, margin: 12, minWidth: 200}}>
...
<h4 style={{marginBottom: 12}}>Learning Games</h4>
<Typography color='textSecondary' variant='body2' style={{marginBottom: 20}}>A list of games that can facilitate learning through play.</Typography>
