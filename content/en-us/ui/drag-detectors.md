...
<video src="../assets/input/drag-detectors/Showcase.mp4" controls width="100%" alt="Drag detectors used in a variety of implementations in the 3D world"></video>
...
1. From the menu, insert a **DragDetector**.
   ...
   <img src="../assets/input/drag-detectors/DragDetector-New.png" width="320" />
...
<video src="../assets/input/drag-detectors/Balance-Tower.mp4" controls width="90%" alt="Drag detectors placed on each piece of a tower balance game"></video>
...
<video src="../assets/input/drag-detectors/Desk-Drawers.mp4" controls width="90%" alt="Drag detectors placed on the drawers of a desk to allow for opening/sliding"></video>
...
<video src="../assets/input/drag-detectors/Marionette.mp4" controls width="90%" alt="Drag detectors placed on the handles of a marionette puppet"></video>
...
<video src="../assets/input/drag-detectors/Color-Slider.mp4" controls width="90%" alt="Drag detectors used in 3D user interface to control a particle emitter"></video>
