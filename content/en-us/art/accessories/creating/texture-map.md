...
1. Next to **Base Color**, select the **yellow dot**, then click **Image Texture** from the contextual menu.
...
1. Click the **+ New** button.
   ...
   1. Set the color to black or any base color of your preference.
   1. Keep the rest of the default settings.
   1. Press **OK** when completed.
