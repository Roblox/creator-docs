...
In all methods, creating and combining multiple facial expressions over a duration of time results in a face animation. You cannot import face animations; these methods are the only ways to create and utilize them.
