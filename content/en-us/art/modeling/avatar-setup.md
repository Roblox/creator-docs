...
The **Publish** button opens the publish asset dialog, with an option to upload the avatar and any accessory items to the [Creator Store](../../production/publishing/creator-store.md) or [Marketplace](../../art/marketplace/publishing-to-marketplace.md).
