...
- **Resolution** — Roblox supports up to 4096×4096 pixel texture resolutions (4K). As a game loads, the engine automatically starts with lower quality versions of the texture and ramps up quality based on device resources. Even still, manually sizing textures before you upload them can improve memory usage in some situations. Consider the following general guidance:
  ...
  - See [PBR texture budgets](#surface-appearance) for similar guidances with PBR texture maps.
...
You can add a [surface appearance](../../art/modeling/surface-appearance.md) to your mesh in Studio to add PBR texture options. The `Class.SurfaceAppearance` instance uses UV mapping, a form of texture mapping, to accurately map 2D images onto the mesh object.
...
<table>
  ...
  <tbody>
    <tr>
      <td>[Albedo](./surface-appearance.md#color-albedo)</td>
      <td>RGB (24-bit)</td>
    </tr>
    <tr>
...
<table>
	...
	<tr>
		<td>256×256</td>
		<td>2×2×2</td>
		<td>Hair, shoes, tank tops, t-shirts, shorts, short skirts. <br/><br/>256x256 is the **maximum budget** for non-albedo maps for [rigid accessories](../../avatar/rigid-accessories/specifications.md#textures).</td>
	</tr>
	<tr>
		<td>512×512</td>
		<td>4×4×4</td>
