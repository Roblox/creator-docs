...
<CardActions style={{position: 'absolute', bottom: 0, width: '100%'}}>
  <Button href="../../assets/modeling/meshes/reference-files/shoebot-base-model.fbx" fullWidth size='large' color='primary' variant='contained' style={{marginBottom:"0px;"}}>Download</Button>
</CardActions>
</Card>
</Grid>
...
<CardActions style={{position: 'absolute', bottom: 0, width: '100%'}}>
  <Button href="../../assets/modeling/skinned-meshes/CreatureModel.fbx" fullWidth size='large' color='primary' variant='contained' style={{marginBottom:"0px;"}}>Download</Button>
</CardActions>
</Card>
</Grid>
