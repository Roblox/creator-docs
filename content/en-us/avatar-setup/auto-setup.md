...
Studio supports `.gltf`, `.fbx`, and `.obj` models using the Importer. If you are exporting your model from a third-party tool, see [Export Settings](../art/characters/export-settings.md) for export configurations.
