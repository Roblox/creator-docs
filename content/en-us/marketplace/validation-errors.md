...
When [uploading avatar items](./publish-to-marketplace.md#upload-an-asset) to the Marketplace, Roblox validates the submission to ensure that the asset meets the appropriate specification for that asset type, such as [clothing specifications](../avatar/layered-accessories/specifications.md).
...
- [Generic mesh specifications](../art/modeling/specifications.md)
- [Rigid accessory mesh specifications](../avatar/rigid-accessories/specifications.md#geometry-and-budgets)
- [Clothing mesh specifications](../avatar/layered-accessories/specifications.md#geometry-and-budgets)
- [Body mesh specifications](../avatar/character-bodies/specifications.md#triangle-budgets)
...
- [General texture requirements](../art/modeling/texture-specifications.md)
- [PBR texture overview](../art/modeling/surface-appearance.md)
- [Clothing texture requirements](../avatar/layered-accessories/specifications.md#textures)
- [Body texture requirements](../avatar/character-bodies/specifications.md#textures)
...
- [Generic mesh specifications](../art/modeling/specifications.md#rigging-and-skinning)
- [Clothing rigging specifications](../avatar/layered-accessories/specifications.md#rigging-and-skinning)
- [Body rigging specifications](../avatar/character-bodies/specifications.md#rigging)

Skinning is the assignment of vertices of your rendered mesh to the underlying rig. For additional resources, see the rigging and skinning requirements for [clothing](../avatar/layered-accessories/specifications.md#rigging-and-skinning) and [bodies](../avatar/character-bodies/specifications.md#rigging).
...
- [Caging best practices and video](../avatar/layered-accessories/caging-best-practices.md)
- [Clothing caging specifications](../avatar/layered-accessories/specifications.md#cage-meshes)
- [Body outer cage specifications](../avatar/character-bodies/specifications.md#outer-cages)
...
<tbody>
  ...
  <tr id = "cageMeshDistance">
    ...
    <td>The outer cage is too far away from its corresponding body or accessory model mesh. You need to [remodel the outer cage](../avatar/layered-accessories/caging-best-practices.md) and bring its vertices closer to the model mesh.</td>
  </tr>
  ...
  <tr>
    ...
    <td>The layered accessory mesh vertices need to be positioned between the [inner and outer cages](../avatar/layered-accessories/caging-best-practices.md). Whenever a mesh vertex passes through the cage mesh it causes rendering issues in the area making the accessory look like it is intersecting the body.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Your outer cage was deformed in regions that don't envelop any part of your accessory. For example, the outer cage for a hat accessory is expected to deform on the head region and not the left foot. Make sure your outer cage is [properly setup](../avatar/layered-accessories/caging-best-practices.md) and deforms only where is needed.</td>
  </tr>
  <tr>
    ...
    <td>Ideally the outer cage of an accessory completely envelops its model mesh. There are cases in which you may [intentionally not want to do that](../avatar/layered-accessories/caging-best-practices.md#caging-protrusions). For example, if the accessory is a wing, you would want the outer cage to envelop only the base of the wing that connects it to the back of the avatar. If the entire wing is enveloped, it'll cause extreme deformations to any additional layered assets equipped.<br/><br/>This validation checks that the outer cage is enveloping a large enough region of the accessory. You need to edit the outer cage to contain more vertices of the accessory mode mesh. </td>
  </tr>
  <tr>
...
- [Rigid accessory specifications](../avatar/rigid-accessories/specifications.md)
- [Clothing specifications](../avatar/layered-accessories/specifications.md)
...
- [Clothing overview](../avatar/layered-accessories/index.md)
- [Clothing specifications](../avatar/layered-accessories/specifications.md)
...
<tbody>
   <tr id = "cageDensity">
    ...
    <td>Your accessory cage has too many vertices close together. This may cause the system to treat them as repeated vertices, or zero area triangles. You need to [edit and move](../avatar/layered-accessories/caging-best-practices.md) the vertices away from each other in the region(s) they are almost coincident.</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>Make sure you converted your model into a layered accessory (you might have [converted to a rigid accessory](../avatar/accessory-fitting-tool.md#rigid-accessories) instead or selected the wrong asset type).</td>
  </tr>
  <tr>
    <td>The maximum vertex density has been exceeded. Reduce the number of vertices that are very close to each other.</td>
    <td>Your accessory cage has too many vertices close together. This may cause the system to treat them as repeated vertices, or zero area triangles. You need to [edit and move the vertices away](../avatar/layered-accessories/caging-best-practices.md) from each other in the region(s) they are almost coincident.</td>
  </tr>
...
- [Body specifications](../avatar/character-bodies/specifications.md)
...
<tbody>
  <tr>
    ...
    <td>Body attachments, except grip attachments, [should not have an applied rotation](../avatar/character-bodies/specifications.md#attachments). This would affect all accessories connected to these attachments and can make some accessories look "broken" when equipped to the body.</td>
  ...
  <tr>
    ...
    <td>Body attachments need to be within reasonable distance from the body[should not have an applied rotation](../avatar/character-bodies/specifications.md#attachments) to avoid introducing unrealistic gaps when equipping accessories to those attachments.</td>
  </tr>
  <tr>
...
- [Head specifications](../avatar/character-bodies/specifications.md#facial-animation)
...
<tbody>
  ...
  <tr>
    ...
    <td>The face controls for dynamic heads need to have [at least 17 poses](../avatar/character-bodies/specifications.md#facial-animations) connected to the rig. This is necessary to enforce a minimum level of face expressions for avatars during gameplay. You need to setup additional face controls that are missing.</td>
  </tr>
  <tr>
