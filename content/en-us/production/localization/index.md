...
Your game's localization settings is the starting place for enabling
...
2. In the **Experiences** tab, find your game and select the **&ctdot;** button.
...
game has been written in. Roblox currently only supports one source
...
for. You can have multiple supported languages for your game. See
...
For more information on enabling automatic translations in your game, see [Automatic translations](../../production/localization/automatic-translations.md).
...
For more information on custom translation use-cases, see [Translate in-game content](../../production/localization/manual-translations.md).
