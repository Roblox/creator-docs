...
As part of your [promotional](../../production/promotion/index.md) initiatives, the integrated **Events** system lets you create time-based events for your experience. Players can discover your events on the experience's detail page and through an [event details page](#event-details-page). Players can also opt into [notifications](#streampush-notifications) that they'll receive when your event begins.
...
2. In the left column, expand the **Engagement** branch and click **Events**.

   <img src="../../assets/creator-dashboard/Experience-Nav-Engagement-Events.png" width="330" alt="Events button indicated for an experience on the Creator Dashboard" />

3. Click the **Create Event** button and then, on the event creation screen:

   1. Enter the **event name**, a starting date/time, and an ending date/time.
   2. Select one or two **event types** from the dropdowns that accurately describe your event:
      ...
      <tbody>
        <tr>
          ...
          <td>An update that adds new items or pets.</td>
        </tr>
        <tr>
          <td>**Location Update**</td>
          <td>An update that adds a new map.</td>
        </tr>
        <tr>
          <td>**System Update**</td>
          <td>An update that adds new features like trading.</td>
        </tr>
        <tr>
          <td>**Activity**</td>
...
1. On an experience's **Events** page, click the tab corresponding to the event's timing (**Active**, **Scheduled**, or **Finished**).
