...
Roblox treats experiences without Experience Guidelines the same as experiences with an age recommendation of Ages 13+, meaning they cannot display to younger users or contain any [17+ content](https://en.help.roblox.com/hc/articles/15869919570708) without risk of moderation. For this reason, Roblox strongly recommends that you fill out the questionnaire for each of your experiences so that they're available to the largest appropriate audience possible.

<img src="../../assets/promotion/Experience-Guidelines-Example.png" />
...
If your Roblox account is at least 30 days old, you can generate Experience Guidelines by filling out the **Experience Questionnaire**, which is a set of questions about the type of content users can possibly encounter within your experience, as well as how frequently it occurs. Your answers give Roblox an understanding of the content within your experience and ensure that the experience is available to the appropriate audience.

<Alert severity="warning">
   If your experience is going to have [17+ content](https://en.help.roblox.com/hc/articles/15869919570708), it must only be restricted to verified users who are at least 17 years old. You must not add the 17+ content before generating Experience Guidelines with an age recommendation of Ages 17+.
</Alert>

As you are completing the questionnaire, **base your answers on the most mature or extreme content users can encounter within your experience**. Unless you receive an age recommendation of Ages 17+, you can retake the questionnaire and generate new Experience Guidelines at any time to accurately reflect what group of users should be able to access your experience.

To generate Experience Guidelines:

1. **(Optional)** If you want your experience to include 17+ content, confirm you are at least 17 years old by [verifying your account](../../production/publishing/account-verification.md) so the Experience Questionnaire can ask questions to generate the correct age recommendation of Ages 17+.
1. Navigate to the [Creator Dashboard](https://create.roblox.com/dashboard/creations).
1. Click on the experience you want to generate experience guidelines for. The experience's **Overview** page displays.
1. In the left-hand navigation, select **Questionnaire**. If you've never taken the questionnaire before, the **Questionnaire Not Started** page displays, otherwise the **Questionnaire Requires Update** page displays.

   <img src="../../assets/promotion/Questionnaire-Highlighted.jpg"
   width="20%" />
...
1. If you need to modify a previous answer, click the **Edit** button, otherwise click the **Submit** button. The Experience Guidelines immediately display on the experience's main page. In addition, if your experience receives an age recommendation of Ages 17+, all game servers restart to remove all users except for those age-verified as 17+, and Studio removes all users except for those age-verified as 17+from any active team create session.

   <img src="../../assets/promotion/Questionnaire-Preview.jpg"
   width="80%" />

As long as your experience didn't receive an age recommendation of Ages 17+, if you believe that the rating does not match your intended audience, you can update the content in your experience so that your experience is appropriate for your target audience, then resubmit the questionnaire. To learn how you can dynamically adjust the content of your experience for different audiences, see the `Class.PolicyService` API reference.

<Alert severity="warning">
   If you publish an update that changes any of the answers from the questionnaire, you **must** return and update your answers to reflect the accuracy of your experience's content to remain compliant with Roblox's [Community Standards](https://en.help.roblox.com/hc/en-us/articles/203313410-Roblox-Community-Standards) and [Terms of Use](https://en.help.roblox.com/hc/articles/115004647846).
</Alert>
...
After you finish the questionnaire, your experience receives an age recommendation with content descriptors according to the following table.
...
<Alert severity="info">
   To remain compliant with local laws and regulations, Roblox hides experiences with an age recommendation of Ages 17+ from users in specific countries, such as Korea, Saudi Arabia, and Turkey.
</Alert>

### Violence

Violence is the intentional use of physical or psychological force against users or non-playable characters (NPCs). If your experience includes violence, including within any [asset type](../../projects/assets/index.md#asset-types), you must disclose it within the Experience Questionnaire based on the violence's level of intensity and how often a user might encounter it.

#### Level of Intensity

After you confirm that your experience contains violence, you must specify whether the level of intensity of violence within your experience is **mild**, **moderate**, or **strong**. If you imply violence anywhere within your experience, such as violence that occurs off-screen that users can hear but can't see, your experience automatically meets the mild criteria.
...
- Roblox provides a moderation action.
  ...
  - If your experience otherwise has inaccurate Experience Guidelines according to its content, Roblox will remove the Experience Guidelines (or only the descriptors if the age recommendation is Ages 17+) from your experience. Roblox treats unrated experiences the same as experiences with an age recommendation of Ages 13+, meaning they are not recommended to users under 9, nor playable by users with **Allowed Experiences** set to All Ages or 9+.
