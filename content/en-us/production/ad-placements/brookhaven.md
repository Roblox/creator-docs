---
title: Brookhaven
description: See how Brookhaven implements rewarded video ad placements.
...
---
  ...
  return (<>
    <div style={{ marginBottom: 48, marginTop: -48 }}>
      ...
      <div style={heroTitleStyle}>Brookhaven</div>
    ...
    <Placement
      ...
      src="/assets/ads/brookhaven.png"
      alt="Brookhaven rewarded video placement in the HUD"
      location="HUD"
      reward="VIP trial"
      highlights={<>Offers players a timed trial of exclusive premium items directly from the HUD. It acts as a highly effective "try-before-you-buy" mechanic that drives immediate engagement with gated content.</>}
    />
  </>);
  })()}
