---
title: Adopt Me
description: See how Adopt Me implements rewarded video ad placements.
...
---
  ...
  const Placement = ({ number, src, alt, location, reward, rewardType, highlights, href }) => (
    <div style={placementStyle}>
      <a href={href} target="_blank" rel="noopener noreferrer" style={{ display: 'block', maxWidth: '50%' }}>
  ...
  return (<>
      <div style={{ marginBottom: 48, marginTop: -48 }}>
        ...
        <div style={heroTitleStyle}>Adopt Me</div>
        <span className="placement-badge">In menu</span>
    </div>

    <Placement
        number={1}
        href="https://www.roblox.com/games/920587237/Adopt-Me"
        src="/assets/ads/adoptme.png"
        alt="Adopt Me rewarded video placement in the daily login menu"
        location="In menu"
        reward="Daily login bonus"
        highlights={<>An intuitive in-menu daily login multiplier that rewards players the moment they load into the game. It capitalizes on initial session momentum to instantly boost retention and daily login values.</>}
    />
  </>);
})()}
