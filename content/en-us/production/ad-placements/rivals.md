---
title: RIVALS
description: See how RIVALS implements rewarded video ad placements.
...
---
  ...
  return (<>
    <div style={{ marginBottom: 48, marginTop: -48 }}>
      ...
      <div style={heroTitleStyle}>RIVALS</div>
      <span className="placement-badge">In world</span>
    </div>

    <Placement
      number={1}
      href="https://www.roblox.com/games/17625359962/RIVALS"
      src="/assets/ads/rivals.png"
      alt="RIVALS rewarded video placement in the world"
      location="In world"
      reward="Premium trial"
      highlights={<>An immersive, native integration utilizing an in-world "TV spawn room" to offer premium items. This organic placement blends perfectly with the game's environment without disrupting gameplay.</>}
    />
  </>);
  })()}
