---
title: Evade
description: See how Evade implements rewarded video ad placements.
...
---
  ...
  return (<>
    <div style={{ marginBottom: 48, marginTop: -48 }}>
      ...
      <div style={heroTitleStyle}>Evade</div>
    ...
    <Placement
      ...
      src="/assets/ads/evade.png"
      alt="Evade rewarded video placement in a pop-up"
      location="Pop-up"
      reward="Revive"
      highlights={<>A high-stakes pop-up revival option specifically designed to save and protect a player’s win streak. By safeguarding their competitive progress, it turns high-tension moments into incredibly high-value ad placements.</>}
    />
  </>);
  })()}
