...
description: See how Blue Lock Rivals implements rewarded video ad placements.
...
---
  ...
  return (<>
    <div style={{ marginBottom: 48, marginTop: -48 }}>
      ...
      <div style={heroTitleStyle}>Blue Lock Rivals</div>
      <span className="placement-badge">In shop</span>
    </div>

    <Placement
      number={1}
      href="https://www.roblox.com/games/18668065416/Blue-Lock-Rivals"
      src="/assets/ads/bluelock.png"
      alt="Blue Locks Rivals rewarded video placement in the shop"
      location="In shop"
      reward="Progressive rewards"
      highlights={<>A dedicated rewarded ads shop featuring a progressive reward ladder with an enticing final bonus. This structured milestone mechanic encourages sustained, multi-ad engagement from players looking to maximize their gains.</>}
    />
  </>);
  })()}
